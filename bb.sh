...
create_archive_page() {
    ...
    # Create the archive list
    {
        ...
        disqus_footer
    # remove the back to the index
    } | grep -v "Back to the index page" > "$filename"
}
...
all_posts() {
    ...
    create_archive_page "$contentfile" "$archive_index.tmp" yes "$global_title &mdash; $template_archive_title" "$global_author"
